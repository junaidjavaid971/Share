...
class ZerodhaHtaFragment(var callbacks: Button1FragmentCallbacks) : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_zerodha_hta, container, false)
    }
    ...
    private fun manageClicks() {
        btnApply.setOnClickListener {
            callbacks.onZerodhaApplyClicked()
        }
    }
