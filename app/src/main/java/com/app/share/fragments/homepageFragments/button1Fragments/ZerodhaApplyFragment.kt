...
class ZerodhaApplyFragment(var callback: Button1FragmentCallbacks) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_zerodha_apply, container, false)
        return view
    }
